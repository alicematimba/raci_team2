...
This stage covers writing learning outcomes, designing curriculum structure, deciding on assessment, and handing off to Technical Developers.
...
|------|------|----------------|
| **A** | Informatics Training Lead (for computational & data elements) / Lab Training Lead (for lab elements) | Accountable that outcomes are scientifically grounded and appropriate for the learner level — reviews and approves them. |
...
!!! warning "Clarification: A as a quality gate, not authorship"
    The Training Lead's A here is a quality gate — they approve what the Education Developer has structured, in collaboration with SMEs. They do not write learning outcomes themselves. Their review specifically covers whether the outcomes reflect appropriate computational & data approaches or experimental methods for the audience and learning level — and whether they hold regardless of whether delivery is in-person, virtual or online. If the outcomes aren't fit for purpose, the Lead is accountable for not catching it.

---

## Designing the curriculum structure and flow

| RACI | Role | Responsibility |
|------|------|----------------|
| **A** | Informatics Training Lead (for computational & data elements) / Lab Training Lead (for lab elements) | Accountable that the curriculum is coherent, appropriately sequenced and domain-credible — approves the structure. |
| **R** | Education Developer(s) | Designs the curriculum structure — sequences the elements, determines the flow between them, and decides on the instructional approach. On multi-element events the Education Developer coordinates across both computational & data and lab elements, ensuring the whole is pedagogically coherent even when different Leads have shaped the intent of individual elements. |
| **C** | Digital Learning Developer | Consulted when the curriculum includes digital or online elements — advises on whether the proposed design will work instructionally in a digital format before build begins. This is a design feasibility input, analogous to how Technical Developers advise on infrastructure feasibility. Not involved on courses with no digital or online components. |
| **N/A** | Technical Developers | Not involved at curriculum design stage. |

!!! warning "Clarification"
    The Training Lead validates; they do not design. Curriculum sequencing and modality decisions are instructional design methodology — Education Developer territory. The Lead's validation covers whether the computational & data or experimental content is appropriate for the audience at each stage of the sequence, and applies equally to in-person, virtual and online formats.

---

## Deciding on the assessment and feedback approach

| RACI | Role | Responsibility |
|------|------|----------------|
| **A** | Informatics Training Lead (for computational & data elements) / Lab Training Lead (for lab elements) | Accountable — approves that the assessment reflects what the domain considers meaningful evidence of learning. |
| **R** | Education Developer(s) | Designs the assessment approach — determines what to assess, how, and at what level. |
| **C** | Technical Developers | Consulted if assessment requires a technical environment. |
| **I** | Head of LDD | Informed; consulted only if it represents a novel or significant commitment. |
