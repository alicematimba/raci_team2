...
Not all programmes include formal assessment — and that is a deliberate design decision, not an oversight. Short courses, practicals, and workshop-style events often rely on formative activities, project work, or practical demonstration rather than graded assessment. The Education Developer decides what assessment approach (if any) is appropriate and states this explicitly in the design brief. Where no formal assessment is included, the brief should say so — this prevents Technical Developers building assessment infrastructure that was never intended.

Where formal or graded assessment is included, the following handoff applies:

Assessment design (what the question is, what a good answer looks like, how it is marked) is owned by the Education Developer, in consultation with the relevant Training Lead to confirm the content being assessed reflects current, meaningful practice. Configuring the assessment in the LMS or platform is a separate, technical task.

| Who owns it | What they produce | Who receives it | What they do with it |
|-------------|-------------------|-----------------|----------------------|
| Education Developer | Assessment specification (questions, marking scheme, pass criteria, instructions — or a statement that no formal assessment is included) | Digital Learning Developer / Technical Dev | Configures the assessment in the LMS or platform, or confirms no build is required |
| Training Lead (C) | Approach validity check on assessment content | Education Developer | Revises content before it goes to technical build |
