...
| Education Developer | Content scripts or storyboards | Digital Learning Developer | Produces video, interactive, or multimedia from the script |
...
| Who owns it | What they produce | Who receives it | What they do with it |
|-------------|-------------------|-----------------|----------------------|
| Informatics ED / Lab ED | Technical environment requirements (what learners must be able to do in the environment) | Informatics Technical Dev / Lab Technical Dev | Provisions, configures, and tests the environment |
...
!!! info "Boundary note"
    The Informatics Training Lead does not configure lab infrastructure. The Lab Training Lead does not configure computational environments. Cross-domain technical work is N/A for both Leads — it belongs to the relevant Technical Developer.
